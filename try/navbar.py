...
selection = st.sidebar.radio("Go to", ['Home', 'Pilih Rekomendasi', 'Daftar Rekomendasi', 'Riwayat Rekomendasi'])
...
elif selection == 'Pilih Rekomendasi':
...
elif selection == 'Riwayat Rekomendasi':
